...
zdobytych punktów
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Analiza Listy Przebojów Trójki_files/Analiza Listy Przebojów Trójki_16_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Analiza Listy Przebojów Trójki_files/Analiza Listy Przebojów Trójki_17_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
Poniżej zestawiono 20 utworów o największej sumarycznej liczbie punktów
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Analiza Listy Przebojów Trójki_files/Analiza Listy Przebojów Trójki_19_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
zdobytych przez danego artystę
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Analiza Listy Przebojów Trójki_files/Analiza Listy Przebojów Trójki_23_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
kolejnych notowań?
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Analiza Listy Przebojów Trójki_files/Analiza Listy Przebojów Trójki_25_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
poszczgólnych artystów?
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Analiza Listy Przebojów Trójki_files/Analiza Listy Przebojów Trójki_27_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
danego artysty, a liczbą punktów na dany utwór
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Analiza Listy Przebojów Trójki_files/Analiza Listy Przebojów Trójki_29_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tabular}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Analiza Listy Przebojów Trójki_files/Analiza Listy Przebojów Trójki_33_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
kolaboracji
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Analiza Listy Przebojów Trójki_files/Analiza Listy Przebojów Trójki_35_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
-0.3546783 
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Analiza Listy Przebojów Trójki_files/Analiza Listy Przebojów Trójki_38_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\emph{Again} zespołu \emph{Archive}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Analiza Listy Przebojów Trójki_files/Analiza Listy Przebojów Trójki_40_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tabular}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Analiza Listy Przebojów Trójki_files/Analiza Listy Przebojów Trójki_43_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\paragraph{Test}\label{test}}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Analiza Listy Przebojów Trójki_files/Analiza Listy Przebojów Trójki_45_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
m.in. Brodkę, Katarzynę Nosowską, Lao Che czy Macieja Maleńczuka
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Analiza Listy Przebojów Trójki_files/Analiza Listy Przebojów Trójki_47_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
czy Krzysztow Zalewski
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Analiza Listy Przebojów Trójki_files/Analiza Listy Przebojów Trójki_49_0.png}
    \end{center}
    { \hspace*{\fill} \\}
